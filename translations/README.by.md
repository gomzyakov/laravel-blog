...
Адкрыйце [новы выпуск](https://github.com/gomzyakov/larajournal/issues/new), каб запытаць функцыю (або калі вы знойдзеце памылку).
...
Стварыце вобраз `larajournal` з дапамогай наступнай каманды:
...
[![Выпуск GitHub](https://img.shields.io/github/release/gomzyakov/larajournal.svg)](https://github.com/gomzyakov/larajournal/releases/latest)
[![ліцэнзія](https://img.shields.io/badge/License-MIT-green.svg)](https://github.com/gomzyakov/larajournal/blob/development/LICENSE)
