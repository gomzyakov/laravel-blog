...
Magbukas ng [bagong isyu](https://github.com/gomzyakov/larajournal/issues/new) para humiling ng feature (o kung makakita ka ng bug).
...
Buuin ang imahe ng `larajournal` gamit ang sumusunod na command:
